...
import br.com.rogerio.repository.PessoaRepoitory;
...
public class PessoaController {
	...
	@GetMapping
	public List<Pessoa> listarProjetos() {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Pessoa> atualizarProjetos(@PathVariable Long id, @RequestBody Pessoa pessoa) {
		return pessoaRepository.findById(id)
				.map(objetoGravado -> {
					...
					objetoGravado.setEndereço(pessoa.getEndereço());
